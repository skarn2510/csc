    ...
    {/** first */}
      ...
      <div className="pt-4 pb-10">
        <h1 className="text-black  text-5xl font-bold">
          TRUSTED PRIVATE FINANCER IN DELHI NCR
        </h1>
        <p className="pt-2">
          Loan on Phone is your trusted financial consultant on a mission to
          work on your behalf and procure the most competitive loan solutions.
          We find our association with reputed banks as an efficient Loan
          service provider in Delhi. We handle your loan arrangements on daily
          basis with the help of our learned team of financial consultants.
          Looking for property loan? Fret not! Trust us to offer you befitting
          solution.
        </p>
        </div>
